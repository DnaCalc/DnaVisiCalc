...
$version = "v0.1.2"
$targetDir = "target_release_v0_1_2"
...
Copy-Item "docs/release/WINDOWS_RUN_v0.1.2.md" (Join-Path $stagingDir "README_RELEASE.txt")
Copy-Item "docs/release/HELP_QUICK_REFERENCE_v0.1.2.md" (Join-Path $stagingDir "HELP_QUICK_REFERENCE.txt")
