...
Copy-Item "docs/release/WINDOWS_RUN_v0.1.md" (Join-Path $stagingDir "README_RELEASE.txt")
Copy-Item "docs/release/HELP_QUICK_REFERENCE_v0.1.md" (Join-Path $stagingDir "HELP_QUICK_REFERENCE.txt")
