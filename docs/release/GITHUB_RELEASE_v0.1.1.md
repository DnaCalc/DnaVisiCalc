...
DNA VisiCalc v0.1.1 is a Windows x64 packaged release of the Round 0 pathfinder.

No Rust or Cargo installation is required to run the packaged app.

## Included asset
- `dnavisicalc-v0.1.1-windows-x64.zip`
  - `dnavisicalc.exe`
  - `run_dnavisicalc.bat`
  - `README_RELEASE.txt`
...
1. Download and extract `dnavisicalc-v0.1.1-windows-x64.zip`.
2. Run `dnavisicalc.exe` (or `run_dnavisicalc.bat`).
