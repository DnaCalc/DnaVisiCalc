...
- Additional hardening rounds (11-21) were executed for terminal behavior, dynamic arrays, TUI UX, function-surface expansion, release packaging, and named-formula support.
