...
- Additional hardening rounds (11-23) were executed for terminal behavior, dynamic arrays, TUI UX, function-surface expansion, release packaging, named-formula support, formatting/selection support, and clipboard/paste-special UX.
